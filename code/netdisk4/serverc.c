...
info *pt = NULL;
int timeCount[maxclient] = {0};
int sigfd[maxclient] ={0};
/*
           ...
           while(1)
           {
               ...
               case PUTS:
                   ...
                   else
                   {
                       ...
                       addfile(username,dir_name,argvs,'f',train.buf);
                       printf("上载\n");
                       pthread_create(pid,NULL,recv_thread,(void *)&newfd);
                       times = time(NULL);
                       ctime_r(&times,nowtime);
                       writeLog(username,(char *)"upload file",nowtime,1);
                       usleep(500);
               ...
               case GETS:
                   ...
                   train.len = newfd;
                   pthread_create(pid+1,NULL,send_thread,(void *)&train);
                   usleep(500);
                   break;
               case REMOVE:
